...
interface RideRepo {
    ...
    suspend fun getNearRideInserts(currentLocation: Location, insert: suspend (RideRequest) -> Unit)
    suspend fun getNearRideRequestsForDriver(currentLocation: Location, invoke: suspend (List<RideRequest>) -> Unit, ) // From Driver
